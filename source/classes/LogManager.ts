...
export default class LogManager {
     ...
     */
    public error(message: string, error?: Error | any, context? : BotLogContext): void {
     ...
     */
    private _prepareMetadata(error?: Error | any, context? : BotLogContext): any {
