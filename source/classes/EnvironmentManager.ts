...
export default class EnvironmentManager {
     ...
     */
    public getVariableSafe(key: string, defaultValue?: string): string | undefined {
     ...
     * @public
     * @returns {NodeJS.ProcessEnv} Объект со всеми переменными окружения
     * @example
     * const allEnvVars = envManager.getAllVariables();
     */
    public getAllVariables(): NodeJS.ProcessEnv {
        return { ...process.env };
    }
}